...
public class Game extends Thread{
    ...
    private void saveToDatabase() {
        ...
        WebSocketServer.recordMapper.insert(recordA);
        WebSocketServer.recordMapper.insert(recordB);
    }
    ...
    private void sendMove() {// 向两个Client传递移动信息
        ...
        try {
            ...
            sendAllMessage(resp.toJSONString());
            nextStepA = nextStepB = null;//广播执行以后制空重新等待接受新的值
        } finally {
            lock.unlock();
        }
    }
